...
ActiveRecord::Schema.define(version: 2020_07_23_141327) do
  ...
  create_table "spree_merchants", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "spree_prices", id: :serial, force: :cascade do |t|
    ...
    t.decimal "others", precision: 15, scale: 2, default: "0.0", null: false
  ...
  create_table "spree_samoles", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
